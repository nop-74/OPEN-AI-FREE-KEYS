...
Ключи API, представленные в этом репозитории, предназначены только для образовательных целей и тестирования. Использование этих ключей в производственных целях или для любых действий, нарушающих условия предоставления услуг OpenAI, строго запрещено.

## Внесение вклада

Если у вас есть еще бесплатные ключи API, которыми вы можете поделиться, не стесняйтесь отправлять запрос на получение. Давайте поможем сообществу вместе!
